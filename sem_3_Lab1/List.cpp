...
void IntListSeq() {
	...
	while (definiteFunc != 0) {
		...
		case 30: {
			...
			step[0] = chooseforFirstIteration_ShellSort(testList.getLength());
			int k = 1;
			realloc(step, sizeof(int) * 2);
			while (step[k - 1] != 0) {

				step[k] = chooseStep(step[k - 1], testList.getLength());
				k++;
				realloc(step, sizeof(int)*(k + 2));
			}
			k--;
			testList.Shell(testList.getArr(), testList.getLength(), step);
			testList.Display();
		...
		case 70: {
			...
			ListSequence<int> *seq2 = new ListSequence<int>;
...
void DoubleListSeq() {
	...
	while (definiteFunc != 0) {
		...
		case 70: {
			ListSequence<double> *seq1 = new ListSequence<double>;
			ListSequence<double> *seq2 = new ListSequence<double>;
			ListSequence<double> *seq3 = new ListSequence<double>;
			for (int i = 0; i < 1000; i++) {
				seq1->Append(i);
				seq2->Append(i);
				seq3->Append(i);
